        ...
        <Form {...store.form()} class="space-y-4" resetOnError onError={() => (code = '')}>
            {#snippet children({ errors, processing, clearErrors })}
                ...
                <div class="text-center text-sm text-zinc-500 dark:text-zinc-400">
                    ...
                    <button
                        type="button"
                        class="text-zinc-900 underline decoration-neutral-300 underline-offset-4 transition-colors duration-300 ease-out hover:decoration-current! dark:text-zinc-50 dark:decoration-neutral-500"
