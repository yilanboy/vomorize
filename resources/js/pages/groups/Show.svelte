<script lang="ts">
    ...
    let breadcrumbs = $derived<Breadcrumb[]>([
        {
            label: t['home'],
            url: homeRoute.url({ locale: currentLocaleUrlKey() }),
        },
        {
            label:
                localized<LevelTranslationItem>(level.translations)?.name ?? '',
            url: levelRoute.url({
        ...
        {
            label: interpolate(t['group_title'], {
                id: String(group.sequence),
            }),
        },
    ]);
        ...
        >
            ...
            >
                <div>
                    ...
                    >
                        {interpolate(t['core_vocab_count'], {
                            count: String(vocabularies.length),
                        })}
                    </p>
                </div>
                <span
            ...
            <div
                class="mt-4 grid grid-cols-2 gap-4 text-sm text-zinc-500 dark:text-zinc-400"
            >
            ...
            <div class="mt-6 space-y-3">
                ...
                {#each vocabularies as vocabulary (vocabulary.id)}
                    ...
                    >
                        ...
                        >
                            <div class="min-w-0">
                                ...
                                >
                                    ...
                                    >
                                    <span
                                        class="text-sm text-zinc-500/70 dark:text-zinc-400/70"
                            ...
                            <div class="flex shrink-0 flex-wrap gap-2">
                                ...
                                <div
                                    data-test={`sentence-${vocabulary.id}`}
                                    class="contents"
                                >
                                    <AudioButton
                        ...
                        <div
                            class="mt-4 border-t border-zinc-200 pt-3 dark:border-zinc-800"
                        >
                            <p
    ...
    <StickyActionBar>
        ...
        {:else}
            ...
            {#key quizHref}
                <Link
                    href={quizHref}
                    data-test={activeProgress.stage > 0
                        ? 'start-review'
                        : 'start-learning'}
