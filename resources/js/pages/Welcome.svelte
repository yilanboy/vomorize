...
>
    ...
    >
        <nav class="flex items-center justify-end gap-4">
            {#if auth.user}
                <Link
                    href={toUrl(home({ locale: currentLocaleUrlKey() }))}
            ...
            {:else}
                <Link
                    href={toUrl(login({ locale: currentLocaleUrlKey() }))}
                ...
                <Link
                    href={toUrl(register({ locale: currentLocaleUrlKey() }))}
                    class="inline-block rounded-sm border border-zinc-200 px-5 py-1.5 text-sm leading-normal text-zinc-900 hover:border-zinc-400 dark:border-zinc-800 dark:text-zinc-50 dark:hover:border-zinc-600"
                >
                    Register
                </Link>
        ...
        >
            ...
            >
                ...
                <ul class="mb-4 flex flex-col lg:mb-6">
                    <li
                        class="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-zinc-200 dark:before:border-zinc-800"
                    >
                        <span class="relative bg-zinc-50 py-1 dark:bg-zinc-900">
                            <span
                        ...
                        <span>
                            ...
                            <a
                                ...
                                target="_blank"
                                class="ml-1 inline-flex items-center space-x-1 font-medium text-zinc-900 underline underline-offset-4 dark:text-zinc-50"
                            >
                    ...
                    <li
                        class="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-zinc-200 dark:before:border-zinc-800"
                    >
                        <span class="relative bg-zinc-50 py-1 dark:bg-zinc-900">
                            <span
                                class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-zinc-200 bg-zinc-100 shadow-xs dark:border-zinc-800 dark:bg-zinc-950"
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a
                            ...
                            target="_blank"
                            class="inline-block rounded-sm border border-zinc-900 bg-zinc-900 px-5 py-1.5 text-sm leading-normal text-white hover:bg-zinc-800 dark:border-zinc-50 dark:bg-zinc-50 dark:text-zinc-950 dark:hover:bg-zinc-200"
                        >
                            Deploy now
                        </a>
                    </li>
